...
mixin _$AuthInfo {
 ...
 String get id; String get name; String get email; String get accessToken; String get refreshToken;
...
int get hashCode {
  final _this = this as AuthInfo;
  return Object.hash(runtimeType,_this.id,_this.name,_this.email,_this.accessToken,_this.refreshToken);
}

@override
String toString() {
  final _this = this as AuthInfo;
  return 'AuthInfo(id: ${_this.id}, name: ${_this.name}, email: ${_this.email}, accessToken: ${_this.accessToken}, refreshToken: ${_this.refreshToken})';
}
...
@useResult
$Res call({
 String id, String name, String email, String accessToken, String refreshToken
});
...
/// Create a copy of AuthInfo
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? email = null,Object? accessToken = null,Object? refreshToken = null,}) {
  return _then(AuthInfo(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String email,  String accessToken,  String refreshToken)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthInfo() when $default != null:
return $default(_that.id,_that.name,_that.email,_that.accessToken,_that.refreshToken);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String email,  String accessToken,  String refreshToken)  $default,) {final _that = this;
switch (_that) {
case _AuthInfo():
return $default(_that.id,_that.name,_that.email,_that.accessToken,_that.refreshToken);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String email,  String accessToken,  String refreshToken)?  $default,) {final _that = this;
switch (_that) {
case _AuthInfo() when $default != null:
return $default(_that.id,_that.name,_that.email,_that.accessToken,_that.refreshToken);case _:
  return null;
...
class _AuthInfo implements AuthInfo {
  const _AuthInfo({required this.id, required this.name, required this.email, required this.accessToken, required this.refreshToken});
...
@override
int get hashCode {
    return Object.hash(runtimeType,id,name,email,accessToken,refreshToken);
}

@override
String toString() {
    return 'AuthInfo(id: $id, name: $name, email: $email, accessToken: $accessToken, refreshToken: $refreshToken)';
}
...
/// Create a copy of AuthInfo
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? email = null,Object? accessToken = null,Object? refreshToken = null,}) {
